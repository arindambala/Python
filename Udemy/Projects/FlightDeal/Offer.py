...
for destination in sheety_data:
    ...
    if cheapest_flight.price != 'N/A' and cheapest_flight.price < destination['lowestPrice']:
        pprint(f"Lower priced flight found to {destination['city']}!")
        task.update_least_price(destination['id'], cheapest_flight.price)
        
        notify.send_sms(message_body=f'Low price alert! Only ISO_code {cheapest_flight.price} to fly from {cheapest_flight.origin_airport} to {cheapest_flight.destination_airport}, on {cheapest_flight.out_date} until {cheapest_flight.return_date} !!')
        
        notify.send_whatsapp(message_body=f'Low price alert! Only ISO_code {cheapest_flight.price} to fly from {cheapest_flight.origin_airport} to {cheapest_flight.destination_airport}, on {cheapest_flight.out_date} until {cheapest_flight.return_date} !!')